...
export default class Graph extends React.Component<Props, {}> {
  ...
  render() {
    return (
      <svg className={ styles.svgPane } 　id="svg-graph" width={ this.state.svg_width } height={ this.state.svg_height } xmlns="http://www.w3.org/2000/svg" version="1.1" onMouseDown={ this.handleMouseDown }
        ...
        <g ref="canvas">
          { this.state.nodes.map((d, idx) => {
              return <Node key={ d.label } modelparameter={ this.props.modelparameter } zoom={ this.state.zoom } ref={ d.label } disable={ d.disable } label={ d.label }
                       x={ d.x } y={ d.y } properties={ d.properties } entryPointCallBack={ this.entryPointCallBack } moveCircleCallBack={ this.moveCircleCallBack } currentChosenNode={ this.state.currentChosenNode }
