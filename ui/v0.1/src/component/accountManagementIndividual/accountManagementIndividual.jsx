        ...
        <div className={ styles.accountRoleChange }>
          ...
          <div className={ styles.accountRoleChangeButton }>
            <div className={ styles.accountRoleChangeButtonBox }>
              <div onClick={ this.accountPasswordChange.bind(this) } width="200"><img src="../icon/mono_icons/exchange32.png" className={ styles.icon } />Change Password <span ref="messageChangePassword"></span></div>
            </div>
          </div>
        </div>
        <div className={ styles.accountRoleChange }>
          <div>
            ...
            <div className={ styles.accountRoleChangeButton }>
              <div className={ styles.accountRoleChangeButtonBox }>
                <div onClick={ this.removeAccount.bind(this) } width="200"><img src="../icon/mono_icons/exchange32.png" className={ styles.icon } />Delete<span ref="messageRemoveAccount"></span></div>
              </div>
            </div>
          </div>
        </div>
