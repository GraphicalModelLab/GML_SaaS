...
export default class LoginModal extends React.Component {
  ...
  render() {
    return <div>
             <Modal contentLabel="login" isOpen={ this.state.modalIsOpen } onAfterOpen={ this.afterOpenModal } style={ customStyles } ref="modal">
               <div className={ styles.loginBox }>
                 <img className={ styles.loginLogo } src='../icon/infographic/ccs_logo.png' />
                 <div>
                   <input type="text" placeholder="e-mail address" ref="email" className={ styles.loginInput } />
                 </div>
                 <div>
                   <input type="password" placeholder="password" ref="password" className={ styles.loginInput } />
                 </div>
