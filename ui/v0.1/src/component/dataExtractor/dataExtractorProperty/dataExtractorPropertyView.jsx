        ...
        return <div>
                    <Modal
                        ...
                        <div className={styles.nodePropertyViewTitle}>
                            <h2 ref="subtitle"><div className={styles.modalTitle}>{this.props.label} </div></h2><div onClick={this.closeModal} className={styles.closeButton}><img src="../icon/mono_icons/stop32.png" className={styles.icon}/></div>
                        </div>
                        <div className={styles.nodePropertyViewContent} ref="content">
                            ...
                            { this.state.properties.map((d, idx) => {
                                return <DataExtractorProperty key={"nodeprop"+idx} ref={"prop"+idx} deleteCallBack={this.deleteCallBack} indexKey={d.key} name={d.name} value={d.value} modelparameter={this.props.modelparameter}/>
                            }) }
                        </div>
