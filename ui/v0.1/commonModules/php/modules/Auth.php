...
function login($data)
{
    $auth_config = parse_ini_file(__DIR__."/../config/Auth.ini",true);
    $auth_host_string = $auth_config["auth"]["host"].":".$auth_config["auth"]["port"];

    $curl = curl_init();

    curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/login");
...
function register($data)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/register");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function validate($data)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/validation");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function registerCompany($data)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/registerCompany");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function getSocialConnectStatus($data)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/social/connect/status");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function disconnectFacebook($data)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/social/connect/facebook/disconnect");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function changePassword($data)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/changePassword");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function changeRole($data)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/changeRole");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function removeAccount($data)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$data["companyid"]."/removeAccount");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function googleAppsAuthenticate($data,$companyid)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$companyid."/googleApps/authenticate");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
...
function facebookAppsAuthenticate($data,$companyid)
{
   ...
   curl_setopt($curl, CURLOPT_URL, "http://".$auth_host_string."/auth/".$companyid."/facebookApps/authenticate");
   curl_setopt($curl, CURLOPT_CUSTOMREQUEST, 'POST');
   curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-Type: application/json'));
   curl_setopt($curl, CURLOPT_RETURNTRANSFER,true);
   curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($data));
