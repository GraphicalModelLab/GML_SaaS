...
class GoogleAppsOpenIDConnectorImplV1 @Inject() (httpClient: HttpClient) extends GoogleAppsOpenIDConnector{
  ...
  def getAccessToken(code: String, client_id: String, client_secret: String, redirect_uri: String, grant_type: String="authorization_code"): String={
    httpClient.postParams("https://accounts.google.com/o/oauth2/token",
      Seq[(String,String)](
        ("code",code),
        ("client_id",client_id),
